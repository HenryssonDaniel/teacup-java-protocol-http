...
class ResponseNodeImpl<T> implements ResponseNodeSetter<T> {
  private static final Logger LOGGER = Logger.getLogger(ResponseNodeImpl.class.getName());
  ...
  @Override
  public void setPreviousResponse(ResponseNode<T> previousResponse) {
  ...
  @Override
  public void setSslSession(SslSessionNode sslSession) {
