...
class SslSessionContextNodeImpl implements SslSessionContextNodeSetter {
  private static final Logger LOGGER = Logger.getLogger(SslSessionContextNodeImpl.class.getName());
