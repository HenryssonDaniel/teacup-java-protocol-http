...
class SslSessionNodeImpl implements SslSessionNodeSetter {
  private static final Logger LOGGER = Logger.getLogger(SslSessionNodeImpl.class.getName());
  ...
  private Node<Principal> localPrincipal;
  ...
  private Node<Principal> peerPrincipal;
  ...
  @Override
  public void setLocalPrincipal(PrincipalNode localPrincipal) {
  ...
  @Override
  public void setPeerPrincipal(PrincipalNode peerPrincipal) {
  ...
  @Override
  public void setSessionContext(SslSessionContextNode sessionContext) {
